...
const text = {
  en: {
    ...
    featuredHeading: "Popular Picks",
    featuredIntro: "Start with a few standout pieces, then see the full range.",
    catalogHeading: "More from this range",
    faqHeading: "Frequently Asked Questions",
    faqIntro: "Short answers to the questions shoppers ask most.",
    relatedHeading: "More Gift Ideas",
    relatedIntro: "A few nearby collections worth a look.",
    ...
    collectionsHeading: "Shop by product type",
    collectionsIntro: "If you already know what kind of gift you want, start here.",
    reviewsHeading: "Loved on Etsy",
    reviewsIntro: "A few short reviews that reinforce quality and trust.",
    cardCtaText: "View on Etsy",
    pageNote: "Take a look here, then head to Etsy for prices, reviews and ordering.",
    heroFactsLabel: "Why shoppers feel confident here"
  },
  nl: {
  ...
  pt: {
    ...
    featuredHeading: "Escolhas em destaque",
    featuredIntro: "Começa por algumas peças que se destacam e continua a partir daí.",
    catalogHeading: "Mais para descobrir",
    faqHeading: "Perguntas frequentes",
    faqIntro: "Respostas curtas às perguntas mais comuns.",
    relatedHeading: "Mais ideias de presente",
    relatedIntro: "Outras páginas que vale a pena ver.",
